        ...
        <div className="col-md-3 left_col">
          <div className="left_col scroll-view">
            ...
            <div className="navbar nav_title" style={{"border":"0"}}>
              <a href="index.html" className="site_title"><i className="fa fa-paw"></i> <span>Devconnect</span></a>
            </div>
            ...
            <div id="sidebar-menu" className="main_menu_side hidden-print main_menu">
              ...
              <div className="menu_section">
                ...
                <ul className="nav side-menu">
                  ...
                  <li><a href="javascript:void(0)"><i className="fa fa-laptop"></i> Landing Page <span className="label label-success pull-right">Coming Soon</span></a>
                  </li>
                </ul>
              </div>
